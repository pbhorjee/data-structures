describe('linkedList', function() {
  ...
  it('should have methods named "addToTail", "removeHead", "insertAfter", "getNodeByValue", and "contains"', function() {
  ...
  it("should contain a value that was added", function(){
    linkedList.addToTail(4);
    linkedList.addToTail(5);
    linkedList.insertAfter(linkedList.head, (4.5));
    expect(linkedList.contains(4)).to.equal(true);
    expect(linkedList.contains(5)).to.equal(true);
    expect(linkedList.contains(4.5)).to.equal(true);
    expect(linkedList.contains(6)).to.equal(false);
    linkedList.insertAfter(linkedList.getNodeByValue(4.5), 6);
